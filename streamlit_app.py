...
st.set_page_config(
    page_title="셰빠몽ai",
    page_icon="https://raw.githubusercontent.com/chrisahn99/chaipamon_ai_2.0/main/assets/chaipamon_avatar_v2.PNG",
...
# Sidebar
st.sidebar.image("https://raw.githubusercontent.com/chrisahn99/chaipamon_ai_2.0/main/assets/chaipamon_v2.PNG", use_container_width=True)
st.sidebar.write(f"""
...
for message in st.session_state.messages:  # Write message history to UI
    ...
    if message["role"]=="assistant":
        with st.chat_message(message["role"], avatar='https://raw.githubusercontent.com/chrisahn99/chaipamon_ai_2.0/main/assets/chaipamon_avatar_v2.PNG'):
...
if st.session_state.messages[-1]["role"] != "assistant":
    with st.spinner("셰빠몽 생각중... 기다려주셰용 🙄🙄"):
        with st.chat_message("assistant", avatar='https://raw.githubusercontent.com/chrisahn99/chaipamon_ai_2.0/main/assets/chaipamon_avatar_v2.PNG'):
